...
def gen_rename_index(source_items: List[str], source_ext: str, output_path: str):
    mapping = {str(uuid4()) + source_ext: original_name for original_name in source_items}
    with open(output_path, 'w') as f:
        write_index_file(f, mapping)


gen_rename_index(snakemake.params.source_items,
